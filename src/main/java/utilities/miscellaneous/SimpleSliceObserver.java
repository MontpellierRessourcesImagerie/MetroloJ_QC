...
public class SimpleSliceObserver implements AdjustmentListener, ImageListener, WindowListener, MouseWheelListener {
    ...
    public SimpleSliceObserver(ImagePlus image, SliceListener listener) {
        this.image = image;
    ...
    public static void register(SliceListener listener) {
        ...
        if (ids != null) {
            for (int id : ids) {
                new SimpleSliceObserver(WindowManager.getImage(id), listener);
            }
        }
    }
